      ...
      <div className="home-BG">
        ...
        <div className="about-me" id="about">
          ...
          <p data-aos="zoom-in-down">
            ...
            student exploring the world of web development for over a year now.
            I'm passionate about crafting clean, responsive, and user-focused
            websites—where every line of code adds value, and every design
            choice enhances the experience.
          </p>
        </div>
            ...
            <div className="project-text">
              ...
              >
                <p>
                  ...
                  request permits, clearances, and certificates without visiting{" "}
                  <br />
